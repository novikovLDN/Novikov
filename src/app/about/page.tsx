 ...
 * репутационный риск.
 *
 * Список партнёрских ЦОД исправлен здесь же: он противоречил странице
 * локаций, которую видит покупатель (Германия, Нидерланды, Австрия,
 * США), и назывался «Германия · Россия · Австралия».
 */
const REGISTRY: Array<[string, string]> = [
  ...
  ["Партнёрские ЦОД", "Германия · Нидерланды · Австрия · США"],
    ...
    <div className="px-page">
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24 max-w-[1200px] mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {PRINCIPLES.map((p) => (
            <div key={p.n} className="bg-[color:var(--px-surface)] border border-[color:var(--px-line)] rounded-3xl p-6 sm:p-8 hover:border-[color:var(--px-line-2)] transition-colors">
