...
const RULES: Array<{ say: string; note: string }> = [
  ...
  {
    say: "Шифрование включено всегда.",
    note: "В каждом тарифе и на каждом устройстве, без доплаты и без отдельной настройки.",
  },
  {
        ...
        <section className="a-sheet aa-cover" data-sheet="18" data-title="О нас" aria-labelledby="aa-title">
          ...
          <div className="a-field">
            ...
            <div className="aa-cover-grid">
              <p className="a-lead">
                Atlas Secure — VPS-ускоритель для телефона и компьютера и выделенные серверы для
                проектов и компаний. Ниже — во что мы верим и что можем подтвердить.
              </p>
              <div>
