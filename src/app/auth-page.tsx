      ...
      <PageContainer>
        {step === "email" && (
          <div className="animate-fade-in-up pt-2 sm:pt-6">
            ...
            <a
              href="https://t.me/atlassecure_bot?start=weblogin"
              target="_blank"
              rel="noopener noreferrer"
              className="w-full h-13 sm:h-14 rounded-2xl bg-telegram text-white font-semibold hover:bg-telegram-hover transition-colors flex items-center justify-center gap-2.5 btn-press"
            >
