  ...
  ios: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "На главном экране Shadowrocket выберите добавленный сервер, нажав на него. Затем включите переключатель в верхней части экрана. При первом подключении iOS попросит разрешить VPN-конфигурацию — нажмите «Разрешить»." },
        { text: "Когда переключатель станет активным и в верхней части экрана появится значок VPN — подключение установлено. Shadowrocket также показывает скорость соединения в реальном времени." },
      ],
    },
  ],
  windows: [
  ...
  macos: [
    ...
    },
    {
      ...
      steps: [
        ...
        { text: "Выберите добавленный сервер, нажав на него. Затем включите переключатель в верхней части экрана. При первом подключении macOS попросит разрешить VPN-конфигурацию — введите пароль от Mac и нажмите «Разрешить»." },
        { text: "Когда переключатель станет активным и в строке меню появится значок VPN — подключение установлено. Весь трафик теперь защищён." },
      ],
    },
  ],
  tv: [
