        ...
        <div className="plx-wrap">
          ...
          <div className="plx-fgrid">
            {[
              ...
              { i: "shield", t: "Kill Switch", d: en ? "Halts all traffic instantly on disconnect. No packet leaks to the ISP." : "Мгновенно останавливает весь трафик при разрыве соединения. Ни одного пакета к провайдеру." },
              ...
              { i: "globe", t: en ? "DNS & IPv6 protection" : "Защита DNS и IPv6", d: en ? "All DNS queries routed through encrypted resolvers. IPv6 tunneled or dropped." : "Все DNS-запросы через зашифрованные резолверы. IPv6 туннелируется или отбрасывается." },
        ...
        <div className="plx-wrap">
          ...
          <div className="plx-faq">
            {[
              ...
              { q: en ? "What happens if connection drops?" : "Что если соединение упадёт?", a: en ? "Kill Switch instantly halts all traffic. Not a single packet leaks to your ISP or apps until it reconnects." : "Kill Switch мгновенно останавливает весь трафик. Ни один пакет не утечёт к провайдеру до восстановления соединения." },
