  ...
  return (
    <div className="min-h-dvh flex flex-col">
      ...
      <PageContainer className="space-y-3 sm:space-y-4">
        ...
        {/* ═══ Settings + About ═══ */}
        <div className="flex gap-2.5 animate-fade-in-up animate-delay-4">
          <div className="flex-1">
            <SettingsCard />
          </div>
          <button
            onClick={() => router.push("/about")}
            className="flex-1 h-11 sm:h-12 rounded-2xl bg-card border border-border/50 text-foreground font-medium text-sm sm:text-base hover:bg-card-hover transition-all btn-press flex items-center justify-center gap-2"
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <circle cx="12" cy="12" r="10" />
