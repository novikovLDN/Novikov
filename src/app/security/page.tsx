    ...
    <div className="bg-[#f5f5f0] min-h-dvh flex flex-col text-black">
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24 max-w-[1200px] mx-auto w-full">
        <div className="mb-12 sm:mb-16 max-w-[720px]">
          <div className="font-mts-wide text-[13px] tracking-[0.14em] uppercase text-black/45 mb-4">Защита</div>
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24 max-w-[1200px] mx-auto w-full">
        <div className="mb-12 sm:mb-16 max-w-[720px]">
          <div className="font-mts-wide text-[13px] tracking-[0.14em] uppercase text-black/45 mb-4">Сертификации</div>
          <h2 className="font-mts-wide text-[32px] sm:text-[44px] leading-[1.02] tracking-tight font-bold">
            Проверено<br />третьими сторонами
          </h2>
          <p className="font-mts-wide text-[16px] sm:text-[17px] leading-[1.5] text-black/55 mt-6 max-w-[58ch]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {CERTIFICATIONS.map((c) => (
            <div key={c.t} className="bg-white border border-black/[0.06] rounded-3xl p-6 sm:p-8">
              ...
              <div className="font-mts-wide text-[11px] tracking-[0.12em] uppercase text-black/45 mt-2 mb-4">{c.sub}</div>
              <p className="font-mts-wide text-[13px] sm:text-[14px] leading-[1.55] text-black/60">{c.d}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24 max-w-[900px] mx-auto w-full">
        <div className="mb-10 sm:mb-14">
          <div className="font-mts-wide text-[13px] tracking-[0.14em] uppercase text-black/45 mb-4">Стек шифрования</div>
          <h2 className="font-mts-wide text-[32px] sm:text-[44px] leading-[1.02] tracking-tight font-bold">Глубокая защита</h2>
          <p className="font-mts-wide text-[16px] leading-[1.5] text-black/55 mt-6 max-w-[58ch]">
      ...
      <section className="px-5 sm:px-8 py-16 sm:py-24 max-w-[900px] mx-auto w-full">
        <div className="mb-10 sm:mb-14">
          <div className="font-mts-wide text-[13px] tracking-[0.14em] uppercase text-black/45 mb-4">Прозрачность</div>
      ...
      <section className="bg-[#F97316] text-black px-5 sm:px-8 py-20 sm:py-28 mx-2 sm:mx-3 mt-8 rounded-[28px] sm:rounded-[36px]">
        <div className="max-w-[900px] mx-auto text-center">
          ...
          <p className="font-mts-wide text-[16px] sm:text-[18px] leading-[1.45] text-black/70 mt-6 max-w-[48ch] mx-auto">
