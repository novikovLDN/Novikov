      ...
      <div className="relative bg-[color:var(--px-surface)] border border-[color:var(--px-line)] rounded-2xl  overflow-hidden">
        <div className="p-4 sm:p-5">
          ...
          <a
            ...
            onClick={handleClose}
            className="font-mts-wide mt-3 w-full h-10 sm:h-11 rounded-xl bg-[color:var(--px-accent)] text-white font-medium text-sm hover:bg-[#FF8A6B] transition-all active:scale-[0.985] flex items-center justify-center gap-2"
          >
