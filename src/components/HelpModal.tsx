    ...
    apps: [
      {
        ...
        steps: [
          ...
          "Разрешите создание VPN-подключения во всплывающем окне",
        ],
      },
      {
        name: "Hiddify",
    ...
    apps: [
      {
        ...
        steps: [
          ...
          "Разрешите добавление VPN-конфигурации в настройках iOS",
        ],
      },
      {
        name: "V2RayTun",
        ...
        steps: [
          ...
          "Разрешите VPN-конфигурацию при появлении запроса",
        ],
      },
    ],
  },
    ...
    apps: [
      {
        ...
        steps: [
          ...
          "Разрешите установку VPN-конфигурации при появлении запроса macOS",
        ],
      },
      {
        name: "Streisand",
