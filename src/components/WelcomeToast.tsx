...
export default function WelcomeToast({ telegramLinkToken, subscriptionEnd }: WelcomeToastProps) {
  ...
  return (
    <div className="fixed top-16 right-3 sm:right-6 z-50 w-[calc(100%-1.5rem)] sm:w-auto sm:max-w-sm animate-fade-in-up">
      <div className="relative bg-white border border-[#F97316]/25 rounded-2xl shadow-xl shadow-black/10 overflow-hidden">
        {/* Header */}
        ...
        <div className="p-4 sm:p-5 pt-3 sm:pt-4 flex flex-col gap-2">
          <a
            ...
            className="font-mts-wide h-10 sm:h-11 rounded-xl bg-[#2AABEE] text-white font-medium text-sm hover:bg-[#2AABEE]/90 transition-all active:scale-[0.985] flex items-center justify-center gap-2"
          >
