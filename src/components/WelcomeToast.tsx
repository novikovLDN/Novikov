      ...
      <div className="relative bg-[color:var(--px-surface)] border border-[color:var(--px-accent-line)] rounded-2xl  overflow-hidden">
        ...
        <div className="p-4 sm:p-5 pt-3 sm:pt-4 flex flex-col gap-2">
          <a
            ...
            className="font-mts-wide h-10 sm:h-11 rounded-xl bg-[color:var(--px-accent)] text-white font-medium text-sm hover:bg-[color:var(--px-accent-hi)] transition-all active:scale-[0.985] flex items-center justify-center gap-2"
          >
