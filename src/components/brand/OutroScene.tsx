 ...
 *
 * Раньше корпус здесь возвращался в чернила — страница закрывалась
 * там же, где началась. На светлом корпусе (ТЗ 15.6) этого хода нет:
 * финал остаётся бумагой, а его вес держат кегль заголовка во весь
 * кадр и единственная на весь сайт магнитная кнопка. Закрывать
 * страницу тем, что мы только что назвали проблемой, было бы
 * странно и в прежней системе.
 *
