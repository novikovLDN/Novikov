 ...
 *
 * КОРПУС СВЕТЛЫЙ. Класс `g` рядом с `b-root` включает систему
 * «Гратикул»: внутри неё чернильные токены указывают на бумагу и
 * морские чернила, и все сцены рисуют светлый корпус, не переписывая
 * ни одной строки разметки. Сами приёмы — гонка дорожек, стена,
 * закреплённые сцены, кинетический заголовок — сохранены: они
 * работали и нравятся (docs/ANIMATION_INVENTORY.md). Изменился
 * материал, а не движение.
 */
