 ...
 * человеку: «тебе будет быстрее». Продуктов при этом три
 * (ускорение, выделенные серверы VDS, корпоративные подключения), и
 * два из них адресованы не частному лицу. Посетитель-компания не находил на
 ...
 * направлений («выделенные серверы») без него не различаются между
  ...
  return (
    <section className="px-section" aria-labelledby="group-title">
      <div className="px-shell">
        <SectionHeading
          eyebrow="Направления"
          title={["Одна сеть —", "три способа ей пользоваться"]}
          titleId="group-title"
          index="01"
        />
