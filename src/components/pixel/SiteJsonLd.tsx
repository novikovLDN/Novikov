...
const ORGANIZATION = {
  ...
  alternateName: "Atlas",
  description:
    "Atlas — VPN для телефона и компьютера. Шифрует трафик, меняет страну и открывает то, что перестало открываться. 19 стран, 14 устройств на одной подписке, историю подключений не хранит.",
