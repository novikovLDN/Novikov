    ...
    <section className="ls-section" aria-labelledby="locations-title">
      <div className="ls-shell">
        ...
        <p className="ls-lede ls-reveal -mt-6 mb-12 sm:mb-14">
          Четыре страны сейчас, остальные — по запросу. Партнёрские
          дата-центры уровня Tier-3 и Tier-4: клиент сам выбирает ближайший
          маршрут, а нужную локацию можно закрепить вручную.
        </p>
