...
const METRICS = [
  { value: 4, decimals: 0, suffix: "", label: "страны" },
  { value: 99.98, decimals: 2, suffix: " %", label: "аптайм" },
  { value: 5, decimals: 0, prefix: "< ", suffix: " мс", label: "в регионе" },
  { value: 5, decimals: 0, suffix: "", label: "платформ" },
];
