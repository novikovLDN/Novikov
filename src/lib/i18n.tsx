...
const t = {
  ...
  "hero.desc": {
    en: "Stable connection and low ping on any device. 24/7 with 99.98% SLA. A 25 Gbps channel on Basic and 75 Gbps on Plus, with servers in 19 countries.",
    ru: "Стабильное соединение и низкий пинг на любом устройстве. Канал 25 Гбит/с на тарифе Basic и 75 Гбит/с на Plus, серверы в 19 странах. SLA 99,98%.",
  },
  ...
  "at.dc": { en: "Network", ru: "Сеть присутствия" },
  "at.dc.v": { en: "19 countries", ru: "19 стран" },
